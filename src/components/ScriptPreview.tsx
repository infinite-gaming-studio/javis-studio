    ...
    if (segments.length === 0) {
        return (
            <div className="flex-1 flex flex-col space-y-3 min-h-0">
                ...
                <div className="flex-1 rounded-2xl border border-dashed border-slate-300 py-10 bg-slate-50/50 flex flex-col items-center justify-center gap-3 text-slate-500 group transition-all duration-300 hover:border-violet-300 hover:bg-violet-50/20">
            ...
            <div className="flex-1 space-y-3 overflow-y-auto pr-2 custom-scroll pb-2">
                {segments.map((seg) => {
                    ...
                    return (
                        <div
                            key={seg.index}
                            className="group relative rounded-2xl bg-white/40 backdrop-blur-md border border-white/60 shadow-sm hover:shadow-lg hover:shadow-violet-200/20 p-4 space-y-3 hover:border-violet-200 transition-all duration-300"
                        >
                            <div className="flex items-center gap-2">
                                ...
                                <div className="ml-auto relative">
                                    <select
                                        ...
                                        className="appearance-none text-[11px] font-semibold bg-white/80 hover:bg-white border border-slate-200 hover:border-violet-300 rounded-xl pl-2.5 pr-7 py-1 text-slate-600 outline-none focus:ring-4 focus:ring-violet-500/10 transition-all duration-200 cursor-pointer shadow-sm"
                                    >
                            ...
                            <textarea
                                ...
                                rows={2}
                                className="w-full bg-white/50 hover:bg-white/80 focus:bg-white border border-transparent focus:border-violet-200 rounded-xl p-2.5 text-sm text-slate-800 outline-none resize-none placeholder-slate-400 transition-all duration-200 shadow-none focus:shadow-sm"
                                placeholder="输入脚本内容..."
                            />
                        </div>
                    );
